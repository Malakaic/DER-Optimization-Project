...
#Initialize weigted objective variables
financial_weight = 25
...
class EnergyResourceApp:
    ...
    def create_weighted_objectives_section(self, frame):
        ...
        def save_values():
            ...
            # Save the values
            financial_weight = self.financial_slider.get()
            efficiency_weight = self.efficiency_slider.get()
            sustainability_weight = self.sustainability_slider.get()
            power_quality_weight = self.power_quality_slider.get()
            
            print("Values Saved:")
            print(f"Financial: {financial_weight}")
            print(f"Efficiency: {efficiency_weight}")
            print(f"Sustainability: {sustainability_weight}")
            print(f"Power Quality: {power_quality_weight}")
        ...
        self.financial_slider.set(financial_weight)
        self.efficiency_slider.set(efficiency_weight)
        self.sustainability_slider.set(sustainability_weight)
        self.power_quality_slider.set(power_quality_weight)
